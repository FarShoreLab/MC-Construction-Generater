...
def main() -> int:
    ...
    commands = [
        ...
        ('network-diversity',['org.mcsettlement.planner.NetworkDiversityMain',str(evidence/'network-diversity')]),
        ('site-expert',['org.mcsettlement.planner.ExpertPlanningMain',str(evidence/'site-expert')]),
        ('surface-presets',['org.mcsettlement.planner.SurfacePresetMain']),
        ('preset-controls',['org.mcsettlement.planner.PresetControlsMain']),
        ('next-ai-planning',['org.mcsettlement.planner.NextAiPlanningMain']),
        ('land-bridge',['org.mcsettlement.planner.LandBridgeMain']),
