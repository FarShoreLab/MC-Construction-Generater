...
public final class PlannedBuilding {
    ...
    public static BuildingShape shape(Plot p) {
        ...
        BuildingShape b=new BuildingShape(source.selectEntrance(p.builder.entranceIndex).rotateToFacing(facing),p.builder.diagonal45);
        ...
        } else if(p.builder.diagonal45||b.cells.size()!=b.sizeX*b.sizeZ)throw new IllegalArgumentException("MISSING_EXACT_FOOTPRINT");
        return b;
    }
