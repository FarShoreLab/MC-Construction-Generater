...
public final class BuildingShape {
    ...
    public final int entranceIndex;
    ...
    public BuildingShape(BuildingPreset oriented, boolean diagonal) {
        ...
        entranceIndex=oriented.selectedEntrance;preset=oriented; sourceFacing=oriented.entrance.facing; this.diagonal=diagonal; sizeY=oriented.sizeY;
