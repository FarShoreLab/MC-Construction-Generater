...
public final class RoadGeometry {
    ...
    // Angularly ordered union: 4 shared cardinal + 4 diagonals + 8 oblique lattice moves.
    private static final int[][] MIXED={{1,0},{2,1},{1,1},{1,2},{0,1},{-1,2},{-1,1},{-2,1},{-1,0},{-2,-1},{-1,-1},{-1,-2},{0,-1},{1,-2},{1,-1},{2,-1}};
    public static int[][] directions(int count){return count==16?MIXED:count==12?TWELVE:EIGHT;}
