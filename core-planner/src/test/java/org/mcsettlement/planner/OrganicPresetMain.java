...
public final class OrganicPresetMain {
    ...
    public static void main(String[] args)throws Exception{
        ...
        test("registry_34_active_presets_retains_10_classic",()->{
            var ps=BuildingPresetRegistry.getInstance().getAllPresets();check(ps.size()==34,"Missing presets");check(BuildingPresetRegistry.CLASSIC_IDS.size()==10,"Classic set changed");
