...
public final class OrganicPresetMain {
    ...
    public static void main(String[] args)throws Exception{
        ...
        test("registry_22_presets_retains_10_classic",()->{
            var ps=BuildingPresetRegistry.getInstance().getAllPresets();check(ps.size()==22,"Missing presets");check(BuildingPresetRegistry.CLASSIC_IDS.size()==10,"Classic set changed");
