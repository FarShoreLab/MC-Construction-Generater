...
public final class SimulationApiRunner {
    ...
    private static final class PlanPreview{
        final SitePlanning sitePlanning;final String status,hash;final List<PlotPreview> plots=new ArrayList<>();final List<GroundColumn> groundColumns;
