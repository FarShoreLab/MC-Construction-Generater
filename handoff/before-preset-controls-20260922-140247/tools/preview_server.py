...
def query_values(parsed, terrain_only: bool = False) -> dict[str, str]:
    defaults = {
        ...
        "buildingRepulsion": "1", "roadMergeDistance": "7", "settlementMode": "village", "siteSeed": "follow", "maxPlanAttempts": "3",
        "width": "128",
        "depth": "128",
        "baseElevation": "58",
        "relief": "24",
    ...
    if defaults["presetPalette"] not in {"classic", "mixed", "compact", "spacious", "single", "crafted", "estates"}:
