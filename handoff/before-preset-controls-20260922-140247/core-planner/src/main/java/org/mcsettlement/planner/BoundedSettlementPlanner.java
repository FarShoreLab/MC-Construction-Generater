...
final class BoundedSettlementPlanner {
    ...
    static List<Demand> demands(PlanRequest req,HeightfieldMap map) {
        ...
        if(requirements.isEmpty()&&!"classic".equals(req.presetPalette))
            requirements.addAll("estates".equals(req.presetPalette)?PresetPalette.capacityRequirements(map,req):PresetPalette.requirements(req.presetPalette,req.singlePresetId,req.targetPlots,req.expert==null?null:req.expert.settlementMode));
