package org.mcsettlement.planner.parcel;
    ...
    private static boolean isValidPlotLocation(
        ...
        for (int x = minX; x <= maxX; x++) {
            for (int z = minZ; z <= maxZ; z++) {
                ...
                if (obs == ObstacleType.EXISTING_BUILDING || obs == ObstacleType.WATER || obs == ObstacleType.WATER_DEEP || obs == ObstacleType.STEEP_CLIFF) {
                    return false;
                }
